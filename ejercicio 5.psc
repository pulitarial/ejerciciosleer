Algoritmo ejercicio_5
	...
	escribir "El usuario compro un paquete de " velocidad_promocional " megas y la velocidad relevante en realidad es de " (velocidad_promocional * CONVERSION_MEGABIT_A_MEGABYTE ) " megabytes"
